...
Ez_potential = {}
Ez_potential['ALA'] = [0, -0.2, 10.22, 4.67]
Ez_potential['ASP'] = [0, 1.19, 14.25, 8.98]
Ez_potential['GLU'] = [0, 1.30, 14.66, 4.16]
Ez_potential['PHE'] = [0, -0.2, 19.67, 7.12]   # mm mod, since this value looks to high and I only get TRP 
Ez_potential['GLY'] = [0, -0.01, 13.86, 6.00]
Ez_potential['HIS'] = [0, 0.75, 12.26, 2.77]
Ez_potential['ILE'] = [0, -0.2, 14.34, 10.69]
Ez_potential['LYS'] = [0, 1.66, 11.11, 2.09]
Ez_potential['LEU'] = [0, -0.2, 17.34, 8.61]
Ez_potential['MET'] = [0, -0.2, 18.04, 7.13]
...
Ez_potential['VAL'] = [0, -0.2, 11.35, 4.97]
#equation 3
Ez_potential['TRP'] = [1, -0.2, 11.65, 7.20] # mm mod to -.65, since this value looks to high and I only get TRP 
Ez_potential['TYR'] = [1, -0.2, 13.04, 6.20]
